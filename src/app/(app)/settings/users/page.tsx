  ...
  return (
    <div className="space-y-5">
      ...
      <Card>
        ...
        {users.map((u) => <UserRow key={`${u.id}:${u.role}:${u.isActive}:${u.name}`} u={u} self={u.id === me.id} locked={u.locked} />)}
      </Card>
      <Card>
        ...
        <CardBody className="overflow-x-auto">
          <table className="w-full text-[12.5px]">
            ...
            <tbody>
              {[["admin", "✓", "✓", "✓", "✓", "✓", "✓", "✓ apply", "✓"], ["manager", "✓", "✓", "—", "approve", "—", "—", "✓ apply", "—"], ["procurement", "✓", "—", "✓", "record / match", "—", "✓", "✓ apply", "—"], ["finance", "—", "—", "close", "record / match / approve", "✓", "—", "run", "—"], ["sales", "✓", "—", "—", "—", "—", "—", "run", "—"], ["operations", "—", "—", "receive", "—", "—", "SKUs / stock", "run", "—"], ["requester", "✓ own", "—", "—", "—", "—", "—", "run", "—"], ["viewer", "—", "—", "—", "—", "—", "—", "—", "—"]].map((r) => (
